        ...
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-gray-50/50 p-4 sm:p-6 lg:p-8">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-xl sm:shadow-none sm:bg-transparent p-6 sm:p-0">
                ...
                <div className="mb-8 text-center sm:text-left">
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Welcome Back</h1>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <Input
                                ...
                                className={`pl-11 h-12 rounded-xl border-gray-200 bg-gray-50/30 focus:bg-white transition-all ${errors.email ? 'border-red-500 ring-red-100' : 'focus:ring-blue-100'
                                    }`}
                            />
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <Input
                                ...
                                onChange={handleChange}
                                placeholder="••••••••"
                                className={`pl-11 pr-11 h-12 rounded-xl border-gray-200 bg-gray-50/30 focus:bg-white transition-all ${errors.password ? 'border-red-500 ring-red-100' : 'focus:ring-blue-100'
                                    }`}
                            />
                            <button
                                type="button"
