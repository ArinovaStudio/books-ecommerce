...
export function GuardianForm() {
  ...
  const sendOrder = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.guardianName.trim())
      newErrors.guardianName = "Parent name is required";
            ...
            <form onSubmit={sendOrder} className="space-y-4 sm:space-y-5">
              ...
              <Card className="mt-4 border-blue-200 bg-blue-50 dark:bg-blue-950/20 dark:border-blue-900">
                <CardContent className="p-3 sm:p-4">
                  <p className="text-xs sm:text-sm text-blue-900 dark:text-blue-100">
                    <strong>NOTE:</strong> Your order will be delivered to the
                    address provided above. Please ensure the details are
                    correct.
                  </p>
                </CardContent>
              </Card>
              ...
              {user?.children?.length > 0 ? (
                ...
                <div className="pt-2 sm:pt-4 text-center">
                  <p className="text-sm">
                    You don’t have any children in this school or the fees
                    haven’t been paid.
                  </p>
                </div>
              )}
