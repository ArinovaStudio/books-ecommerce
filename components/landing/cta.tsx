    ...
    return (
        <section className="py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                {/* Yellow CTA */}
                <div className="bg-yellow-400 p-12 flex flex-col justify-between rounded-none rounded-tr-3xl rounded-bl-3xl">
                    <div>
                        <h3 className="text-2xl font-bold text-gray-900 mb-4">Confidence that builds a brighter future.</h3>
                        <p className="text-gray-800 text-sm mb-6">Empowering kids with self-confidence to face the world</p>
                    </div>
                    <Button className="bg-gray-900 hover:bg-gray-800 text-white w-fit rounded-none rounded-tr-2xl rounded-bl-2xl px-6">Book Now →</Button>
                </div>

                {/* Orange CTA */}
                <div className="bg-orange-500 p-12 flex flex-col justify-between text-white rounded-none rounded-tr-3xl rounded-bl-3xl">
                    <div>
                        <h3 className="text-2xl font-bold mb-4">Helping kids to shoot their dreams.</h3>
                        <p className="text-orange-100 text-sm mb-6">Turning aspirations into achievable goals for students</p>
                    </div>
                    <Button className="bg-white hover:bg-gray-100 text-orange-500 w-fit rounded-none rounded-tr-2xl rounded-bl-2xl px-6">Learn More →</Button>
                </div>
            </div>
