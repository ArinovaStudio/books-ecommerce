...
export default function Header() {
  ...
  const NavLink = ({
    ...
    return (
      <Link
        ...
        scroll={false}
        onClick={onClick}
        className="text-gray-700 hover:text-blue-900 font-medium text-sm transition cursor-pointer"
      >
        {label}
      </Link>
    );
  ...
  return (
    <header className="bg-white sticky top-0 z-70 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-0">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Button className="bg-blue-950 hover:bg-blue-800 text-white px-6 rounded-lg cursor-pointer" onClick={() => router.push("/schools")}>
              Shop Now
            </Button>
          </div>

          {/* TABLET ICONS (MD ONLY) */}
          <div className="hidden md:flex lg:hidden items-center gap-4">
            <ShoppingCart size={22} className="text-gray-700 cursor-pointer" />
            <User size={22} className="text-gray-700 cursor-pointer" />

            <Button
              className="px-4 py-1.5 text-sm bg-blue-950 hover:bg-blue-800 text-white rounded-lg cursor-pointer" onClick={() => router.push("/schools")}
            >
              Shop Now
            </Button>
